...
class ModelTraining:
    def __init__(self, data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key = 'bDA0TzuZNS7X9GM4QwCFlNOxU',
            project_name = 'ml-ops-project-2',
            workspace = 'mananjain2464'
        )
    ...
    def load_data(self):
        try:
            ...
            raise CustomException('Failed to load data during model training' ,e)
    ...
    def train_model(self):
        try:
            ...
            raise CustomException('Failed during training model in model_training.py' ,e)
    ...
    def save_model_weights(self , model):
        try:
            ...
            logger.error(str(e))
            raise CustomException('Error during Saving the model and weights',e)
