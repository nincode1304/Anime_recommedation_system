...
class DataProcessor:
    ...
    def scale_ratings(self):
        try:
            ...
            logger.info('Standardized the rating columns successfully')
        except Exception as e:
    ...
    def split_data(self , test_size = 1000 , random_state = 43):
        try:
            ...
            raise CustomException('Failed to split data successfully' , sys)
    
    def save_artifactas(self):
        try:
            artifacts = {
            ...
            logger.info('All traing and testing data saved')
        except Exception as e:
    ...
    def process_anime_data(self):
        try:
            ...
            raise CustomException('Failed to save df and synopsis df' , sys) 
